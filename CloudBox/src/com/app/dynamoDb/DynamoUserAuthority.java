...
public class DynamoUserAuthority {
    ...
    private static void insert(String UserID, String FileID, String UserName)
    {
    	 Map<String, AttributeValue> item = new HashMap<String, AttributeValue>();
         item.put("UserID", new AttributeValue(UserID));
         item.put("FileURL", new AttributeValue(FileID));
         item.put("SharedUsers", new AttributeValue(UserName));

         
         PutItemRequest putItemRequest = new PutItemRequest("UserAuthority", item);
